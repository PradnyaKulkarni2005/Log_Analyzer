...
func main() {
	filepath := flag.String("file","log.txt","path to log file")
	showErrors := flag.Bool("errors", true, "show error count")
	showInfo := flag.Bool("info", true, "show info count")
	showIP := flag.Bool("ip", true, "show IP stats")
	flag.Parse() // parse the command-line flags
	file, err := os.Open(*filepath) // open the log file specified by the user
